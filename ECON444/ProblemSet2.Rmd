...
In perfect competition we know that price is marginal revenue. Let's calculate
marginal revenue from market demand. We will use the same method as in problem 1.

\[\text{MR} = \frac{d(p * Q)}{dQ}\]
\[\text{MR} = \frac{d((\frac{Q - 1000}{-50}) * Q)}{dQ} = \frac{d(\frac{Q^2 - 1000Q}{-50})}{dQ} = 50 (1000 - 2Q)\]

Since firms will be at profit max, $\text{MR} = \text{MC} = p$.
...
In perfect compeition **Q will be 500** and **price will be 10**.
