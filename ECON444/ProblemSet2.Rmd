...
\[\frac{dQ}{dP}\frac{P}{Q} = \frac{d(1000 - 50p)}{dP}\frac{P}{Q} = \frac{-50 * 15}{250} = -0.6\]

The elasticity of demand at monopoly equilibrium is **-0.6**.
...
\[\frac{15 - 10}{15} = \frac{1}{0.6}\]
\[\frac13 \neq \frac{10}6\]

The markup rule is not satisfied at our monopoly equilibrium.
